...
function OrderHistoryPage() {
    ...
    const fetchHistory = async () => {
        try {
            ...
            // Lấy array từ res.data.data (khớp với controller return res.status(200).json({ success: true, data: orders }))
    ...
    return (
        <div style={{ padding: "20px", maxWidth: "1000px", margin: "0 auto", fontFamily: "Segoe UI, sans-serif" }}>
            ...
            <div style={{ background: "#fff", borderRadius: "12px", border: "1px solid #eee", boxShadow: "0 4px 12px rgba(0,0,0,0.05)", overflow: "hidden" }}>
